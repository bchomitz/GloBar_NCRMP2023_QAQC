...
atlanticBarData_raw <- read_excel(paste(rootFolder,"/globalBar-main/analysis/data/NCRMP_Atlantic_2023_BRC_12_4_2024.xlsx",sep="")) #import data
pacificBarData_raw <- read_excel(paste(rootFolder,"/globalBar-main/analysis/data/NCRMP_Pacific_2023_BRC_12_4_2024.xlsx",sep=""))#import data
